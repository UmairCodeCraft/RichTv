    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0 pt-4 pt-lg-0" >
        ...
        <li className="nav-item">
          ...
          <NavLink to="/Services" className='nav-link' aria-current="Services_page">Services</NavLink>
        </li>
        <li className="nav-item">
          {/* <a class="nav-link" href="#" aria-current="about_page">About Us</a> */}
          <NavLink to="/About" className='nav-link' aria-current="about_page">About Us</NavLink>
        </li>
        ...
        <li className="nav-item">
          ...
          <NavLink to="/Contact" className='nav-link' aria-current="contact_page">Contact Us</NavLink>
        </li>
        <li className="nav-item">
          {/* <a class="nav-link" href="#" aria-current="contact_page">Contact Us</a> */}
          <NavLink to="/Watchlist" className='nav-link' aria-current="Watchlist_page">Watchlist</NavLink>
        </li>
      </ul>
